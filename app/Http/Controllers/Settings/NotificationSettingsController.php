...
class NotificationSettingsController extends Controller
{
    public function edit(Request $request): Response
    {
        ...
        return Inertia::render('settings/Notifications', [
            'preferences' => [
                ...
                'commentReplyNotificationsEnabled' => $preference->comment_reply_notifications_enabled,
    ...
    public function update(NotificationSettingsUpdateRequest $request): RedirectResponse
    {
        ...
        $preference->fill([
            ...
            'comment_reply_notifications_enabled' => $request->boolean('comment_reply_notifications_enabled'),
