...
<template>
    ...
    <div
        class="welcome-page flex min-h-screen flex-col items-center p-6 text-[#1b1b18] lg:justify-center lg:p-8"
    >
        <header
...
.welcome-page {
    background-image: linear-gradient(
        133deg,
        rgba(42, 123, 155, 0.4) 0%,
        rgba(87, 199, 133, 0.4) 50%,
        rgba(237, 221, 83, 0.4) 100%
    );
}
</style>
