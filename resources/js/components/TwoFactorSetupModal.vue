...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'A autenticação em duas etapas está ativa. Escaneie o código QR ou informe a chave de configuração no seu aplicativo autenticador.',
            buttonText: 'Fechar',
        };
    }
    ...
    return {
        ...
        description:
            'Para concluir a ativação, escaneie o código QR ou informe a chave de configuração no seu aplicativo autenticador',
        buttonText: 'Continuar',
    };
});
