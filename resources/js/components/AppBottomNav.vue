...
<template>
    ...
    >
        <div
            class="mx-auto flex max-w-lg items-center justify-around rounded-full border border-border/60 bg-background/50 px-2 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] shadow-lg backdrop-blur-lg"
        >
            <AppNavLink
